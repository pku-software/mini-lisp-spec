...
> **版本 20230313** [谷雨同学](https://guyutongxue.site)制订
...
过程调用写作一对小括号。首先，对小括号内的首个表达式求值，得到被 *被调方*。随后，其余表达式从前至后依次求值后，做为传入该过程的 *实参*。
...
当 *操作符* 恰为符号类型的外部表示，且与本文档所定义的其它语法相冲突时，遵循相关语法的规定而非视为过程调用。这些语法称为 *特殊形式*。
